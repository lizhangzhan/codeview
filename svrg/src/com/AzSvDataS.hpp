...
public: 
  ...
  static void readMatrix_Small(const char *fn, AzSmat *m_data) {
    readData_Small(fn, -1, m_data); 
  }
  static void readMatrix_Large(const char *fn, AzSmat *m_data) {
    readData_Large(fn, -1, m_data); 
  }                               
